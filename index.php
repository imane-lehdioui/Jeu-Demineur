...
<head>
  <meta charset="UTF-8">
  <title>DEMINEUR ET MATEUR</title>
  <link rel="stylesheet" href="PDEMINEUR.css"></link>
...
var nbrbomb =  parseInt(prompt("Entrez le nombres de mine que vous voulez de 10 à 25 maximum :"))
...
$N= 0;
	if ($dif== "Beginner") {
		$N=10;
	} else if ($dif== "Interemediat") {
		$N=15;
	} else {
		$N=20;
	}
?>  
		<div> Bonjour  <b> <?php echo $a;?>  <?php echo $b;?></b></div>

 <table border="1" align="center">
   <tr align="center">
      <td>Temps écoulé :
      <div class="chronometre">
      <div class="tim"><span >0 s</span> </div></div></td>

      <td>Mines restantes : <span id='flags-left'> 0</span></td>
    </tr>
    <tr>
      <td colspan="2" align="center" ><div class="box"  >
    <div class="jeu" ></div>
      </td>
    </tr>
    <tr>
    ...
    <a href="deconnexion.php" class="deconnexion">Disconnection</a>
